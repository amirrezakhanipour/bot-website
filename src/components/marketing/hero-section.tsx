        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-zinc-400 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Automate the ingestion and execution of MetaTrader 5 trading signals with built-in position sizing, multi take-profit target management, break-even management, duplicate order protection, signal expiration rules, and risk limits.
            </p>
            ...
            <div className="relative rounded-2xl bg-zinc-900/90 border border-zinc-800 shadow-2xl overflow-hidden backdrop-blur-xl">
              <div className="px-4 py-3 bg-zinc-950/80 border-b border-zinc-800/80 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5 text-xs font-mono text-zinc-400">
                  ...
                  <span>MT5 EXECUTION // UI PREVIEW</span>
                </div>
              ...
              <div className="p-5 space-y-4 font-mono text-xs">
                <div className="p-3 rounded-lg bg-zinc-950 border border-zinc-800/80 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-zinc-300 text-[11px] pt-1">
                    <div>
                      <span className="text-zinc-500">Symbol:</span> FROM SIGNAL
                    </div>
                    <div>
                      <span className="text-zinc-500">Direction:</span> BUY / SELL
                    </div>
                    <div>
                      <span className="text-zinc-500">Entry:</span> SIGNAL-DEFINED
                    </div>
                    <div>
                      <span className="text-zinc-500">Stop Loss:</span> REQUIRED
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-zinc-400 text-[11px]">
                    <span>MULTI-TP STRUCTURE</span>
                    <span className="text-zinc-500">UP TO 6 TARGETS</span>
                  </div>

                  <div className="space-y-1.5">
                    <div className="p-2 rounded bg-zinc-950/60 border border-zinc-800/50 flex items-center justify-between gap-3">
                      <span className="text-emerald-400 font-medium">TP 1</span>
                      <span className="text-[10px] text-zinc-400 text-right">Signal-defined target</span>
                    </div>
                    <div className="p-2 rounded bg-zinc-950/60 border border-zinc-800/50 flex items-center justify-between gap-3">
                      <span className="text-teal-400 font-medium">TP 2</span>
                      <span className="text-[10px] text-zinc-400 text-right">Lifecycle management milestone</span>
                    </div>
                    <div className="p-2 rounded bg-zinc-950/60 border border-zinc-800/50 flex items-center justify-between gap-3">
                      <span className="text-cyan-400 font-medium">TP 3–6</span>
                      <span className="text-[10px] text-zinc-400 text-right">Used when supplied by the signal</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-2 grid grid-cols-2 gap-2 text-[10px] border-t border-zinc-800/60">
                  ...
                  <div className="p-2 rounded bg-zinc-950/40 border border-zinc-800/40 flex items-center gap-1.5 text-zinc-400">
                    ...
                    <span>Risk-Based Position Sizing</span>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4 py-2 bg-zinc-950/90 border-t border-zinc-800/80 flex items-center justify-between text-[10px] font-mono text-zinc-500">
                <span>PREVIEW: NO LIVE DATA</span>
                <span>MT5 CONNECTION: NOT SHOWN</span>
              </div>
            </div>
          </div>
        </div>
